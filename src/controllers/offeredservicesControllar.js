...
const fs = require("fs");
const recordModel = require("../models/servicesofferdModal");
...
function getofferedservicesRecord(req, res) {
  try {
    recordModel.getofferedservices((err, results) => {
      if (err) {
...
function createofferedservicesRecord(req, res) {
  try {
    ...
    recordModel.createofferedservices(recordData, (err, result) => {
      if (err) {
...
function updateofferedservicesRecord(req, res) {
  try {
    const { id } = req.params;
    const recordData = req.body;
    ...
    recordModel.updateofferedservices(id, recordData, (err, result) => {
      if (err) {
...
function deleteofferedservicesRecord(req, res) {
  try {
    const { id } = req.params;
    recordModel.deleteofferedservices(id, (err, result) => {
      if (err) {
