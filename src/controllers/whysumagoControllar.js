...
const fs = require("fs");
const recordModel = require("../models/whysuamgomodel");
...
function getwhysumagoRecord(req, res) {
  try {
    recordModel.getwhysumago((err, results) => {
      if (err) {
...
function createwhysumagoRecord(req, res) {
  try {
    ...
    recordModel.createwhysumago(recordData, (err, result) => {
      if (err) {
...
function updatewhysumagoRecord(req, res) {
  try {
    const { id } = req.params;
    const recordData = req.body;
    ...
    recordModel.updatewhysumago(id, recordData, (err, result) => {
      if (err) {
...
function deletewhysumagoRecord(req, res) {
  try {
    const { id } = req.params;
    recordModel.deletewhysumago(id, (err, result) => {
      if (err) {
