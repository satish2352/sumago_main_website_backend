...
const fs = require("fs");
const recordModel = require("../models/hometechnologies");
...
function gethometechnologiesRecord(req, res) {
  try {
    recordModel.gethometechnologies((err, results) => {
      if (err) {
...
function createhometechnologiesRecord(req, res) {
  try {
    ...
    recordModel.createhometechnologies(recordData, (err, result) => {
      if (err) {
...
function updatehometechnologiesRecord(req, res) {
  try {
    const { id } = req.params;
    const recordData = req.body;
    ...
    recordModel.updatehometechnologies(id, recordData, (err, result) => {
      if (err) {
...
function deletehometechnologiesRecord(req, res) {
  try {
    const { id } = req.params;
    recordModel.deletehometechnologies(id, (err, result) => {
      if (err) {
