...
const fs = require("fs");
const recordModel = require("../models/homecardmodel");
...
function gethomecardsRecord(req, res) {
  try {
    recordModel.gethomecards((err, results) => {
      if (err) {
...
function createhomecardsRecord(req, res) {
  try {
    ...
    recordModel.createhomecards(recordData, (err, result) => {
      if (err) {
...
function updatehomecardsRecord(req, res) {
  try {
    const { id } = req.params;
    const recordData = req.body;
    ...
    recordModel.updatehomecards(id, recordData, (err, result) => {
      if (err) {
...
function deletehomecardsRecord(req, res) {
  try {
    const { id } = req.params;
    recordModel.deletehomecards(id, (err, result) => {
      if (err) {
